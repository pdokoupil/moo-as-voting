...
class normalizing_marginal_gain_support_function:
    def __init__(self, objective, user):
        ...
        self.cache_value_normalized = None
    ...
    def __call__(self, item, context):
        ...
        if recsys_list is None: # TODO think about this (is this reasonable?)
            ...
            self.cache_value_normalized = self.normalization.predict(self.cache_value) # Normalize the objective value
            return self.cache_value_normalized
        ...
        if hasattr(self.objective, "optimized_computation"):
            ...
            return self.normalization.predict(new_obj) - self.cache_value_normalized
